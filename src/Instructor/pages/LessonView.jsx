...
const curriculum = [
    {
        id: 1, title: "Introduction to Digital Marketing", color: "#7C3AED", icon: "📚",
        lessons: [
    ...
    {
        id: 2, title: "Search Engine Optimization (SEO)", color: "#EA580C", icon: "🔍",
        lessons: [
    ...
    {
        id: 3, title: "Social Media Marketing", color: "#059669", icon: "📱",
        lessons: [
    ...
    {
        id: 4, title: "Content Marketing", color: "#2563EB", icon: "✏️",
        lessons: [
    ...
    {
        id: 5, title: "Email Marketing", color: "#DB2777", icon: "✉️",
        lessons: [
    ...
    {
        id: 6, title: "Google Ads & Analytics", color: "#D97706", icon: "📊",
        lessons: [
    ...
    return (
        <div className="min-h-screen bg-[#F6F7FB] flex flex-col">
            ...
            <nav className="bg-white border-b border-gray-200 px-5 h-18 flex items-center gap-4 sticky top-0 z-40 shadow-sm">
                ...
                <Link
                    to={`/instructor/course-preview/${courseId || 1}`}
                ...
                <main className="flex-1 overflow-y-auto bg-[#F6F7FB] px-6 py-6">
                    ...
                    ${activeTab === t.key
                                ...
                                <div className="space-y-3">
                                    {content.resources.map((r, i) => (
                                        <div key={i} className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-violet-200 hover:shadow-sm transition-all group">
                                            ...
                                            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-[#F6F7FB] border border-gray-200 rounded-lg text-xs font-semibold text-gray-600 hover:bg-violet-50 hover:border-violet-400 hover:text-violet-700 transition-all flex-shrink-0 cursor-pointer">
                        ...
                        <div className="flex items-center justify-between gap-3 mt-10 pt-6 border-t border-gray-200">
                            {prevLesson ? (
                                <Link
                                    to={`/instructor/course/${courseId || 1}/lesson/${prevLesson.id}`}
                            ...
                            {nextLesson ? (
                                <Link
                                    to={`/instructor/course/${courseId || 1}/lesson/${nextLesson.id}`}
                                    ...
                                    <div className="bg-[#F6F7FB]">
                                        {mod.lessons.map((lesson) => {
                                            ...
                                            return (
                                                <Link
                                                    key={lesson.id}
                                                    to={`/instructor/course/${courseId || 1}/lesson/${lesson.id}`}
