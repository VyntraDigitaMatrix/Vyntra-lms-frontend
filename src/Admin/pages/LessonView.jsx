...
const LessonTypeIcon = ({ type, completed }) => {
    ...
    return <FaPlay className="text-teal-600 w-3 h-3 flex-shrink-0" />;
};
...
const LessonView = () => {
    ...
    const colors = ["#0d9488", "#EA580C", "#059669", "#2563EB", "#DB2777", "#D97706"];
    const icons = ["📚", "🔍", "📱", "✏️", "✉️", "📊"];
        ...
        <div className="min-h-screen bg-[#F6F7FB] flex flex-col">
            ...
            <nav className="bg-white border-b border-gray-200 px-5 h-18 flex items-center gap-4 sticky top-0 z-40 shadow-sm">
                ...
                <button
                    ...
                    className="lg:hidden flex items-center justify-center p-2 bg-[#F6F7FB] border border-gray-200 rounded-lg text-gray-500 hover:text-teal-600 hover:border-teal-400 transition-all"
                >
            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                <main className="flex-1 overflow-y-auto bg-[#F6F7FB] px-6 py-6">
                        ...
                        {videoEmbed ? (
                            ...
                            <div className="bg-slate-900 rounded-xl overflow-hidden shadow-sm aspect-video w-full max-h-[480px] flex flex-col items-center justify-center p-6 text-center text-white border border-slate-800">
                                {currentLesson?.lessonType === "PDF" ? (
                                    ...
                                    <>
                                        <FaFileAlt className="text-teal-500 w-14 h-14 mb-4" />
                    ...
                    <div className="max-w-4xl mx-auto px-6 py-6 pb-12">
                        ...
                        <div className="flex items-start justify-between gap-4 mb-6">
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 flex-wrap mb-2">
                                    <span className="text-[11px] font-bold px-3 py-1 rounded-full bg-teal-100 text-teal-700 border border-teal-200">
                            ...
                            {currentLesson?.id && (
                                !completedLessons.has(currentLesson.id) ? (
                                    <button
                                        ...
                                        className="flex-shrink-0 flex items-center gap-2 px-4 py-2.5 rounded-xl bg-teal-600 text-white text-sm font-bold shadow-[0_2px_12px_rgba(13,148,136,0.3)] hover:bg-teal-700 hover:-translate-y-0.5 transition-all duration-200 whitespace-nowrap border-none cursor-pointer"
                                    >
                        ...
                        <div className="flex border-b border-gray-200 mb-6 overflow-x-auto">
                            {tabs.map(t => (
                                <button
                                    ...
                                    ${activeTab === t.key
                                        ? "text-teal-600 border-b-2 border-teal-600 bg-transparent"
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                                        {content.keyPoints.map((pt, i) => (
                                            <div key={i} className="flex items-start gap-3 p-3 bg-white rounded-xl border border-gray-200">
                                                <div className="w-5 h-5 rounded-full bg-teal-100 border border-teal-200 flex items-center justify-center flex-shrink-0 mt-0.5">
                                                    <FaCheck className="text-teal-600 text-[8px]" />
                                                </div>
                                                <div 
                        ...
                        {activeTab === "notes" && (
                            <div className="space-y-5">
                                <div className="p-5 bg-white rounded-xl border border-gray-200 border-l-4 border-l-teal-500">
                                    <p className="text-[11px] font-bold text-teal-600 uppercase tracking-wider mb-2">Instructor Notes</p>
                                    <div 
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={7}
                                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 outline-none resize-none focus:border-teal-500 transition-colors"
                                    />
                                    <button className="mt-2.5 px-5 py-2.5 bg-teal-600 text-white text-sm font-bold rounded-lg hover:bg-teal-700 transition-colors border-none cursor-pointer">
                                        Save Notes
                                    </button>
                                </div>
                            </div>
                                ...
                                {content.resources.length === 0 ? (
                                    ...
                                    <div className="space-y-3">
                                        {content.resources.map((r, i) => (
                                            <div key={i} className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-teal-200 hover:shadow-sm transition-all group">
                                                ...
                                                <a 
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#F6F7FB] border border-gray-200 rounded-lg text-xs font-semibold text-gray-600 hover:bg-teal-50 hover:border-teal-400 hover:text-teal-700 transition-all flex-shrink-0 cursor-pointer no-underline"
                                                >
                                    ...
                                    {qaData.map((qa, i) => (
                                        <div key={i} className="bg-white border border-gray-200 rounded-xl p-4">
                                            <div className="flex items-center gap-2.5 mb-2">
                                                <div className="w-7 h-7 rounded-full bg-teal-100 flex items-center justify-center text-[11px] font-bold text-teal-700 flex-shrink-0">
                                                    {qa.user[0]}
                                                </div>
                            ...
                            {nextLesson ? (
                                ...
                                >
                                    <div className="min-w-0 text-right">
                                        <p className="text-[10px] text-teal-300 uppercase tracking-wider mb-0.5">Next Lesson</p>
                ...
                `}>
                    ...
                    <div className="px-4 py-4 border-b border-gray-100 sticky top-0 bg-white z-10">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-teal-600 whitespace-nowrap">{progressPct}%</span>
                        </div>
                                                ...
                                                lessons.map((lesson) => {
                                                    ...
                                                    return (
                                                        <Link
                                                            ...
                                                            ${isActive
                                                                ? "bg-teal-50 border-r-[3px] border-teal-600"
                                                                : "border-r-[3px] border-transparent hover:bg-teal-50/50"
                                                            }`}
                                                        >
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                ${isActive ? "font-bold text-teal-700" : isDone ? "font-medium text-gray-400" : "font-medium text-gray-600"}`}
                                                                >
                                                                    {lesson.title}
                                                                </p>
