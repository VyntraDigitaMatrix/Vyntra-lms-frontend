...
const HeroSection = () => {
  return (
    <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-4 sm:pt-5 overflow-visible">
      {/* Figma Background Glows: Ellipse 2 (Blue #76B3FF at 60%) & Ellipse 1 (Amber #FEC453) */}
      <div
        className="absolute top-[340px] sm:top-[380px] left-[5%] sm:left-[18%] lg:left-[18%] w-[245px] h-[325px] bg-[#76B3FF] rounded-full pointer-events-none z-0"
        style={{ filter: 'blur(160px)', opacity: 0.6 }}
      />

      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-6 xl:gap-10">
        {/* Left Column: Content & Actions */}
        <div className="w-full lg:w-[480px] xl:w-[560px] shrink-0 flex flex-col items-start z-10">
          {/* Top Badge */}
          <div
            className="inline-flex items-center gap-2.5 bg-[#F4F5F8] backdrop-blur-sm px-1.5 py-1 rounded-full border border-gray-200/80 shadow-xs mb-6 sm:mb-4"
          ...
          {/* Heading */}
          <h1
            className="text-4xl sm:text-5xl lg:text-[62px] xl:text-[68px] font-bold text-[#111827] tracking-tight leading-[1.08] mb-3 text-left"
            style={{ fontFamily: 'Outfit', fontWeight: 500, fontStyle: 'Medium', fontSize: '65px', color: '#000000' }}
          >
            Learn. Build. Get<br />
          ...
          {/* Subtitle */}
          <p
            className="text-[14px] sm:text-[15px] text-[#4B5563] max-w-[480px] leading-relaxed mb-4 text-left"
            style={{ fontFamily: 'Inter', fontWeight: 275, fontStyle: 'ExtraLight', fontSize: '15px', color: '#000000' }}
          >
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8">
            <button
              ...
              className="bg-[#009C59] hover:bg-[#00874e] active:scale-95 px-5 py-3 rounded-full shadow-md shadow-emerald-700/20 transition-all cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-2.5 bg-white border border-[#1B3459] text-[#1B3459] hover:bg-slate-50 active:scale-95 font-bold text-[14px] px-4 py-3 rounded-full transition-all cursor-pointer shadow-xs"
          ...
          <div className="flex flex-col gap-4 mb-8 max-w-[460px] w-full">
            {/* Learn Skills */}
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shrink-0 shadow-xs">
                <svg className="w-5 h-5 text-gray-800" fill="none" stroke="currentColor" strokeWidth="1.6" viewBox="0 0 24 24">
              ...
              <div>
                <h4 style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '14px', color: '#0A0A23' }}>Learn Skills</h4>
                <p className="mt-0.5"
                  style={{ fontFamily: 'Inter', fontWeight: 400, fontStyle: 'Regular', fontSize: '12px', color: '#6B6B7C' }}>
                  Access expert-curated <br />courses in Digital Marketing, Stock Market, IT and more.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shrink-0 shadow-xs">
                <svg className="w-5 h-5 fill-[#F5A624] text-[#F5A624]" viewBox="0 0 24 24">
                  <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                </svg>
              </div>
              <div>
                <h4 style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '14px', color: '#0A0A23' }}>Get Hired Faster</h4>
                <p className="mt-0.5"
                  style={{ fontFamily: 'Inter', fontWeight: 400, fontStyle: 'Regular', fontSize: '12px', color: '#6B6B7C' }}>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <a
              href="#download-ios"
              className="bg-black hover:bg-neutral-800 text-white px-3.5 py-2 rounded-xl flex items-center gap-2.5 transition-colors shadow-sm"
            >
              ...
              <div className="text-left leading-none">
                <div className="text-[9px] text-gray-300 font-medium">Download on the</div>
                <div className="text-[14px] font-semibold tracking-tight mt-0.5" style={{ fontFamily: 'Inter, sans-serif' }}>
                  App Store
                </div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left leading-none">
                <div className="text-[9px] text-gray-300 font-medium uppercase">GET IT ON</div>
                <div className="text-[14px] font-semibold tracking-tight mt-0.5" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Google Play
                </div>
              </div>
        ...
        <div className="relative w-full lg:w-auto flex justify-center lg:justify-start items-center mt-6 lg:mt-20 lg:-ml-2 xl:-ml-4">
          ...
          <img
            src={bgVector}
            alt=""
            className="absolute -top-10 sm:-top-3 -right-6 sm:-right-25 w-[460px] sm:w-[570px] lg:w-[440px] max-w-none pointer-events-none z-0"
            style={{
          ...
          <div className="relative z-[1] w-[340px] sm:w-[440px] lg:w-[480px] flex justify-center items-end">
            ...
            <div
              className="absolute top-8 sm:-top-15 w-[310px] h-[310px] sm:w-[410px] sm:h-[410px] lg:w-[480px] lg:h-[480px] rounded-full overflow-hidden shadow-inner z-0"
              style={{
            ...
            <div className="relative z-10 w-[310px] -top-19 sm:w-[410px] lg:w-[440px] flex justify-center">
              <img
                src={heroImage}
                alt="Vyntra Student"
            ...
            <div className="absolute top-0 sm:-top-18 -left-2 sm:-left-8 lg:left-3 z-30 bg-white/95 backdrop-blur-md rounded-2xl p-3 sm:p-3.5 shadow-[0_12px_32px_rgba(0,0,0,0.08)] border border-gray-100 min-w-[150px] rotate-[5deg]">
            ...
            <div className="absolute top-16 sm:top-8 -right-2 sm:-right-6 lg:-right-20 z-30 bg-white/95 backdrop-blur-md rounded-full py-2 px-2 sm:px-4 shadow-[0_12px_32px_rgba(0,0,0,0.08)] border border-gray-100 flex items-center gap-2.5 sm:gap-3 rotate-[5deg]">
            ...
            <div className="absolute bottom-12 sm:bottom-50 -left-2 sm:-left-4 lg:left-3 z-30 bg-white/95 backdrop-blur-md rounded-full py-2 sm:py-2 px-3.5 sm:px-4 shadow-[0_12px_32px_rgba(0,0,0,0.08)] border border-gray-100 flex items-center gap-2.5 sm:gap-3 rotate-[-9deg]">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#E8F8F0] flex items-center justify-center shrink-0">
